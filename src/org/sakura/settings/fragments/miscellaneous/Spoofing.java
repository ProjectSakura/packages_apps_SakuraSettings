...
import org.sakura.settings.preferences.KeyboxDataPreference;
...
public class Spoofing extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUpdateJsonButton.setOnPreferenceClickListener(preference -> {
            updatePropertiesFromUrl("https://raw.githubusercontent.com/ProjectSakura/.github/refs/heads/main/profile/pif.json");
            return true;
        });
