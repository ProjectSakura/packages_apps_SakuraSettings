...
import com.sakura.settings.fragments.lockscreen.PulseSettings;
import com.sakura.settings.fragments.lockscreen.MediaArtSettings;
import com.sakura.settings.fragments.lockscreen.UdfpsAnimation;
import com.sakura.settings.fragments.lockscreen.UdfpsIconPicker;
...
public class LockScreenSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!hasFingerprint) {
            ...
            if (!Utils.isPackageInstalled(context, "com.sakura.udfps.animations")) {
                gestCategory.removePreference(mUdfpsAnimations);
            }
            if (!Utils.isPackageInstalled(context, "com.sakura.udfps.icons")) {
                gestCategory.removePreference(mUdfpsIcons);
            }
        }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.sakura_settings_lockscreen) {
