...
public class PowerMenuSettings extends SettingsPreferenceFragment {
  ...
  public void onStart() {
    ...
    if (mEmergencyPref != null) {
      ...
      mEmergencyPref.setChecked(
          mLineageGlobalActions.userConfigContains(GLOBAL_ACTION_KEY_EMERGENCY)
              || mForceEmergCheck);
      mEmergencyPref.setEnabled(!mForceEmergCheck);
    }

    if (mDeviceControlsPref != null) {
      mDeviceControlsPref.setChecked(
      ...
      ServiceListing serviceListing =
          new ServiceListing.Builder(mContext)
              ...
              .build();
      serviceListing.addCallback(services -> mDeviceControlsPref.setEnabled(!services.isEmpty()));
  ...
  public boolean onPreferenceTreeClick(Preference preference) {
    ...
    if (preference == mScreenshotPref) {
      ...
      Settings.Global.putInt(
          getContentResolver(), Settings.Global.BUGREPORT_IN_POWER_MENU, value ? 1 : 0);
  ...
  private void updatePreferences() {
    ...
    boolean developmentSettings =
        Settings.Global.getInt(
                getContentResolver(), Settings.Global.DEVELOPMENT_SETTINGS_ENABLED, 0)
            == 1;
    boolean bugReport =
        Settings.Global.getInt(getContentResolver(), Settings.Global.BUGREPORT_IN_POWER_MENU, 0)
            == 1;
