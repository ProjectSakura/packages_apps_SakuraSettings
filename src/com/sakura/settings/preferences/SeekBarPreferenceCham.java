...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String SAKURASETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SAKURASETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, SAKURASETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(SAKURASETTINGSNS, "interval");
            if(newInterval != null)
