...
public class KeyboxDataPreference extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        final ContentResolver sakura = ctx.getContentResolver();
        ...
        boolean hasData = Settings.Secure.getString(
                sakura, Settings.Secure.KEYBOX_DATA) != null;
        ...
        deleteButton.setOnClickListener(v -> {
            ...
            Settings.Secure.putString(sakura, Settings.Secure.KEYBOX_DATA, null);
    ...
    public void handleFileSelected(Uri uri) {
        ...
        final String type = sakura.getType(uri);
        ...
        try (InputStream inputStream = sakura.openInputStream(uri);
            ...
            Settings.Secure.putString(sakura, Settings.Secure.KEYBOX_DATA, xml);
            Toast.makeText(ctx,
